...
# Unit tests for AmzSpApi::ApplicationManagement20231130::Error
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Error' do
  before do
    # run before each test
    @instance = AmzSpApi::ApplicationManagement20231130::Error.new
  end
  ...
  describe 'test an instance of Error' do
    it 'should create an instance of Error' do
      expect(@instance).to be_instance_of(AmzSpApi::ApplicationManagement20231130::Error)
    end
  end
