...
# Unit tests for AmzSpApi::CatalogItems20201201::BrandRefinement
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BrandRefinement' do
  before do
    # run before each test
    @instance = AmzSpApi::CatalogItems20201201::BrandRefinement.new
  end
  ...
  describe 'test an instance of BrandRefinement' do
    it 'should create an instance of BrandRefinement' do
      expect(@instance).to be_instance_of(AmzSpApi::CatalogItems20201201::BrandRefinement)
    end
  end
