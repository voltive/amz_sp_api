...
# Unit tests for AmzSpApi::Invoices20240619::Invoice
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Invoice' do
  before do
    # run before each test
    @instance = AmzSpApi::Invoices20240619::Invoice.new
  end
  ...
  describe 'test an instance of Invoice' do
    it 'should create an instance of Invoice' do
      expect(@instance).to be_instance_of(AmzSpApi::Invoices20240619::Invoice)
    end
  end
