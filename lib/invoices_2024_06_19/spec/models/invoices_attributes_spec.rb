...
# Unit tests for AmzSpApi::Invoices20240619::InvoicesAttributes
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvoicesAttributes' do
  before do
    # run before each test
    @instance = AmzSpApi::Invoices20240619::InvoicesAttributes.new
  end
  ...
  describe 'test an instance of InvoicesAttributes' do
    it 'should create an instance of InvoicesAttributes' do
      expect(@instance).to be_instance_of(AmzSpApi::Invoices20240619::InvoicesAttributes)
    end
  end
