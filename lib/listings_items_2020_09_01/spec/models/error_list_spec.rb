...
# Unit tests for AmzSpApi::ListingsItems20200901::ErrorList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ErrorList' do
  before do
    # run before each test
    @instance = AmzSpApi::ListingsItems20200901::ErrorList.new
  end
  ...
  describe 'test an instance of ErrorList' do
    it 'should create an instance of ErrorList' do
      expect(@instance).to be_instance_of(AmzSpApi::ListingsItems20200901::ErrorList)
    end
  end
