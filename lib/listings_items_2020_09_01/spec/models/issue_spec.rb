...
# Unit tests for AmzSpApi::ListingsItems20200901::Issue
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Issue' do
  before do
    # run before each test
    @instance = AmzSpApi::ListingsItems20200901::Issue.new
  end
  ...
  describe 'test an instance of Issue' do
    it 'should create an instance of Issue' do
      expect(@instance).to be_instance_of(AmzSpApi::ListingsItems20200901::Issue)
    end
  end
