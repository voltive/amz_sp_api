...
describe AmzSpApi::ListingsItems20200901::Configuration do
  let(:config) { AmzSpApi::ListingsItems20200901::Configuration.default }

  before(:each) do
    # uncomment below to setup host and base_path
    # require 'URI'
    # uri = URI.parse("https://sellingpartnerapi-na.amazon.com/")
    # AmzSpApi::ListingsItems20200901.configure do |c|
    #   c.host = uri.host
