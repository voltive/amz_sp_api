...
# Unit tests for AmzSpApi::Reports20210630::CreateReportScheduleSpecification
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateReportScheduleSpecification' do
  before do
    # run before each test
    @instance = AmzSpApi::Reports20210630::CreateReportScheduleSpecification.new
  end
  ...
  describe 'test an instance of CreateReportScheduleSpecification' do
    it 'should create an instance of CreateReportScheduleSpecification' do
      expect(@instance).to be_instance_of(AmzSpApi::Reports20210630::CreateReportScheduleSpecification)
    end
  end
