...
# Unit tests for AmzSpApi::Reports20210630::ReportDocument
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ReportDocument' do
  before do
    # run before each test
    @instance = AmzSpApi::Reports20210630::ReportDocument.new
  end
  ...
  describe 'test an instance of ReportDocument' do
    it 'should create an instance of ReportDocument' do
      expect(@instance).to be_instance_of(AmzSpApi::Reports20210630::ReportDocument)
    end
  end
