...
# Unit tests for AmzSpApi::Reports20210630::GetReportsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetReportsResponse' do
  before do
    # run before each test
    @instance = AmzSpApi::Reports20210630::GetReportsResponse.new
  end
  ...
  describe 'test an instance of GetReportsResponse' do
    it 'should create an instance of GetReportsResponse' do
      expect(@instance).to be_instance_of(AmzSpApi::Reports20210630::GetReportsResponse)
    end
  end
