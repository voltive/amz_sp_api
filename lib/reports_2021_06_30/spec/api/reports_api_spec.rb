...
# Unit tests for AmzSpApi::Reports20210630::ReportsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ReportsApi' do
  before do
    # run before each test
    @instance = AmzSpApi::Reports20210630::ReportsApi.new
  end
  ...
  describe 'test an instance of ReportsApi' do
    it 'should create an instance of ReportsApi' do
      expect(@instance).to be_instance_of(AmzSpApi::Reports20210630::ReportsApi)
    end
  end
