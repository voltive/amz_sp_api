...
# Unit tests for AmzSpApi::ProductPricing20220501::ProductPricingApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProductPricingApi' do
  before do
    # run before each test
    @instance = AmzSpApi::ProductPricing20220501::ProductPricingApi.new
  end
  ...
  describe 'test an instance of ProductPricingApi' do
    it 'should create an instance of ProductPricingApi' do
      expect(@instance).to be_instance_of(AmzSpApi::ProductPricing20220501::ProductPricingApi)
    end
  end
