...
# Unit tests for AmzSpApi::ProductPricing20220501::FeaturedOfferExpectedPriceResponseBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FeaturedOfferExpectedPriceResponseBody' do
  before do
    # run before each test
    @instance = AmzSpApi::ProductPricing20220501::FeaturedOfferExpectedPriceResponseBody.new
  end
  ...
  describe 'test an instance of FeaturedOfferExpectedPriceResponseBody' do
    it 'should create an instance of FeaturedOfferExpectedPriceResponseBody' do
      expect(@instance).to be_instance_of(AmzSpApi::ProductPricing20220501::FeaturedOfferExpectedPriceResponseBody)
    end
  end
