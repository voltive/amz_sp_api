...
# Unit tests for AmzSpApi::ProductPricing20220501::Price
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Price' do
  before do
    # run before each test
    @instance = AmzSpApi::ProductPricing20220501::Price.new
  end
  ...
  describe 'test an instance of Price' do
    it 'should create an instance of Price' do
      expect(@instance).to be_instance_of(AmzSpApi::ProductPricing20220501::Price)
    end
  end
