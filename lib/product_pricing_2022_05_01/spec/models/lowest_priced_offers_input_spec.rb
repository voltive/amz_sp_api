...
# Unit tests for AmzSpApi::ProductPricing20220501::LowestPricedOffersInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LowestPricedOffersInput' do
  before do
    # run before each test
    @instance = AmzSpApi::ProductPricing20220501::LowestPricedOffersInput.new
  end
  ...
  describe 'test an instance of LowestPricedOffersInput' do
    it 'should create an instance of LowestPricedOffersInput' do
      expect(@instance).to be_instance_of(AmzSpApi::ProductPricing20220501::LowestPricedOffersInput)
    end
  end
