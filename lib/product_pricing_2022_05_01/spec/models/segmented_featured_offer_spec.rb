...
# Unit tests for AmzSpApi::ProductPricing20220501::SegmentedFeaturedOffer
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SegmentedFeaturedOffer' do
  before do
    # run before each test
    @instance = AmzSpApi::ProductPricing20220501::SegmentedFeaturedOffer.new
  end
  ...
  describe 'test an instance of SegmentedFeaturedOffer' do
    it 'should create an instance of SegmentedFeaturedOffer' do
      expect(@instance).to be_instance_of(AmzSpApi::ProductPricing20220501::SegmentedFeaturedOffer)
    end
  end
