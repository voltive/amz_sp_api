...
# Unit tests for AmzSpApi::ProductPricing20220501::Offer
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Offer' do
  before do
    # run before each test
    @instance = AmzSpApi::ProductPricing20220501::Offer.new
  end
  ...
  describe 'test an instance of Offer' do
    it 'should create an instance of Offer' do
      expect(@instance).to be_instance_of(AmzSpApi::ProductPricing20220501::Offer)
    end
  end
