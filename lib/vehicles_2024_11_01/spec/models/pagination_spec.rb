...
# Unit tests for AmzSpApi::Vehicles20241101::Pagination
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Pagination' do
  before do
    # run before each test
    @instance = AmzSpApi::Vehicles20241101::Pagination.new
  end
  ...
  describe 'test an instance of Pagination' do
    it 'should create an instance of Pagination' do
      expect(@instance).to be_instance_of(AmzSpApi::Vehicles20241101::Pagination)
    end
  end
