...
# Unit tests for AmzSpApi::SupplySources20200701::OperationalConfiguration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OperationalConfiguration' do
  before do
    # run before each test
    @instance = AmzSpApi::SupplySources20200701::OperationalConfiguration.new
  end
  ...
  describe 'test an instance of OperationalConfiguration' do
    it 'should create an instance of OperationalConfiguration' do
      expect(@instance).to be_instance_of(AmzSpApi::SupplySources20200701::OperationalConfiguration)
    end
  end
