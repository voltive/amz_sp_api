...
# Unit tests for AmzSpApi::SupplySources20200701::GetSupplySourcesResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetSupplySourcesResponse' do
  before do
    # run before each test
    @instance = AmzSpApi::SupplySources20200701::GetSupplySourcesResponse.new
  end
  ...
  describe 'test an instance of GetSupplySourcesResponse' do
    it 'should create an instance of GetSupplySourcesResponse' do
      expect(@instance).to be_instance_of(AmzSpApi::SupplySources20200701::GetSupplySourcesResponse)
    end
  end
