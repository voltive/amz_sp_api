...
# Unit tests for AmzSpApi::SupplySources20200701::SupplySourcesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SupplySourcesApi' do
  before do
    # run before each test
    @instance = AmzSpApi::SupplySources20200701::SupplySourcesApi.new
  end
  ...
  describe 'test an instance of SupplySourcesApi' do
    it 'should create an instance of SupplySourcesApi' do
      expect(@instance).to be_instance_of(AmzSpApi::SupplySources20200701::SupplySourcesApi)
    end
  end
