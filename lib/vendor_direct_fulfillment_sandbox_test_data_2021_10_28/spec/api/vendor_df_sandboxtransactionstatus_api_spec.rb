...
# Unit tests for AmzSpApi::VendorDirectFulfillmentSandboxTestData20211028::VendorDFSandboxtransactionstatusApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VendorDFSandboxtransactionstatusApi' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorDirectFulfillmentSandboxTestData20211028::VendorDFSandboxtransactionstatusApi.new
  end
  ...
  describe 'test an instance of VendorDFSandboxtransactionstatusApi' do
    it 'should create an instance of VendorDFSandboxtransactionstatusApi' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorDirectFulfillmentSandboxTestData20211028::VendorDFSandboxtransactionstatusApi)
    end
  end
