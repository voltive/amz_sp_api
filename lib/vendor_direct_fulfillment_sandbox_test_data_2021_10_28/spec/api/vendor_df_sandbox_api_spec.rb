...
# Unit tests for AmzSpApi::VendorDirectFulfillmentSandboxTestData20211028::VendorDFSandboxApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VendorDFSandboxApi' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorDirectFulfillmentSandboxTestData20211028::VendorDFSandboxApi.new
  end
  ...
  describe 'test an instance of VendorDFSandboxApi' do
    it 'should create an instance of VendorDFSandboxApi' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorDirectFulfillmentSandboxTestData20211028::VendorDFSandboxApi)
    end
  end
