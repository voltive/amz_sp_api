...
# Unit tests for AmzSpApi::VendorShipments::VendorDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VendorDetails' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorShipments::VendorDetails.new
  end
  ...
  describe 'test an instance of VendorDetails' do
    it 'should create an instance of VendorDetails' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorShipments::VendorDetails)
    end
  end
