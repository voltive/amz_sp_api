...
# Unit tests for AmzSpApi::VendorShipments::TransportShipmentMeasurements
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransportShipmentMeasurements' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorShipments::TransportShipmentMeasurements.new
  end
  ...
  describe 'test an instance of TransportShipmentMeasurements' do
    it 'should create an instance of TransportShipmentMeasurements' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorShipments::TransportShipmentMeasurements)
    end
  end
