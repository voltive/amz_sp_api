...
# Unit tests for AmzSpApi::VendorShipments::ShipmentStatusDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ShipmentStatusDetails' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorShipments::ShipmentStatusDetails.new
  end
  ...
  describe 'test an instance of ShipmentStatusDetails' do
    it 'should create an instance of ShipmentStatusDetails' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorShipments::ShipmentStatusDetails)
    end
  end
