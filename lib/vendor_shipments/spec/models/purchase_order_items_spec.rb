...
# Unit tests for AmzSpApi::VendorShipments::PurchaseOrderItems
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PurchaseOrderItems' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorShipments::PurchaseOrderItems.new
  end
  ...
  describe 'test an instance of PurchaseOrderItems' do
    it 'should create an instance of PurchaseOrderItems' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorShipments::PurchaseOrderItems)
    end
  end
