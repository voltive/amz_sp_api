...
# Unit tests for AmzSpApi::VendorShipments::LabelData
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LabelData' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorShipments::LabelData.new
  end
  ...
  describe 'test an instance of LabelData' do
    it 'should create an instance of LabelData' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorShipments::LabelData)
    end
  end
