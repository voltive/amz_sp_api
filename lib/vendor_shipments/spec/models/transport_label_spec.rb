...
# Unit tests for AmzSpApi::VendorShipments::TransportLabel
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransportLabel' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorShipments::TransportLabel.new
  end
  ...
  describe 'test an instance of TransportLabel' do
    it 'should create an instance of TransportLabel' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorShipments::TransportLabel)
    end
  end
