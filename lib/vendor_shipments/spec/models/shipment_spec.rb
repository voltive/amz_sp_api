...
# Unit tests for AmzSpApi::VendorShipments::Shipment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Shipment' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorShipments::Shipment.new
  end
  ...
  describe 'test an instance of Shipment' do
    it 'should create an instance of Shipment' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorShipments::Shipment)
    end
  end
