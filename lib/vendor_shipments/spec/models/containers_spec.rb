...
# Unit tests for AmzSpApi::VendorShipments::Containers
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Containers' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorShipments::Containers.new
  end
  ...
  describe 'test an instance of Containers' do
    it 'should create an instance of Containers' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorShipments::Containers)
    end
  end
