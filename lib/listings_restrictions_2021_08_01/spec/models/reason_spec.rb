...
# Unit tests for AmzSpApi::ListingsRestrictions20210801::Reason
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Reason' do
  before do
    # run before each test
    @instance = AmzSpApi::ListingsRestrictions20210801::Reason.new
  end
  ...
  describe 'test an instance of Reason' do
    it 'should create an instance of Reason' do
      expect(@instance).to be_instance_of(AmzSpApi::ListingsRestrictions20210801::Reason)
    end
  end
