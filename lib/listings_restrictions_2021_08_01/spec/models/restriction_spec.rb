...
# Unit tests for AmzSpApi::ListingsRestrictions20210801::Restriction
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Restriction' do
  before do
    # run before each test
    @instance = AmzSpApi::ListingsRestrictions20210801::Restriction.new
  end
  ...
  describe 'test an instance of Restriction' do
    it 'should create an instance of Restriction' do
      expect(@instance).to be_instance_of(AmzSpApi::ListingsRestrictions20210801::Restriction)
    end
  end
