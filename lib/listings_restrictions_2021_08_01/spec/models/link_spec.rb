...
# Unit tests for AmzSpApi::ListingsRestrictions20210801::Link
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Link' do
  before do
    # run before each test
    @instance = AmzSpApi::ListingsRestrictions20210801::Link.new
  end
  ...
  describe 'test an instance of Link' do
    it 'should create an instance of Link' do
      expect(@instance).to be_instance_of(AmzSpApi::ListingsRestrictions20210801::Link)
    end
  end
