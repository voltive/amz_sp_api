...
# Unit tests for AmzSpApi::Feeds20210630::CreateFeedSpecification
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateFeedSpecification' do
  before do
    # run before each test
    @instance = AmzSpApi::Feeds20210630::CreateFeedSpecification.new
  end
  ...
  describe 'test an instance of CreateFeedSpecification' do
    it 'should create an instance of CreateFeedSpecification' do
      expect(@instance).to be_instance_of(AmzSpApi::Feeds20210630::CreateFeedSpecification)
    end
  end
