...
# Unit tests for AmzSpApi::Feeds20210630::FeedDocument
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FeedDocument' do
  before do
    # run before each test
    @instance = AmzSpApi::Feeds20210630::FeedDocument.new
  end
  ...
  describe 'test an instance of FeedDocument' do
    it 'should create an instance of FeedDocument' do
      expect(@instance).to be_instance_of(AmzSpApi::Feeds20210630::FeedDocument)
    end
  end
