...
# Unit tests for AmzSpApi::Feeds20210630::FeedsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FeedsApi' do
  before do
    # run before each test
    @instance = AmzSpApi::Feeds20210630::FeedsApi.new
  end
  ...
  describe 'test an instance of FeedsApi' do
    it 'should create an instance of FeedsApi' do
      expect(@instance).to be_instance_of(AmzSpApi::Feeds20210630::FeedsApi)
    end
  end
