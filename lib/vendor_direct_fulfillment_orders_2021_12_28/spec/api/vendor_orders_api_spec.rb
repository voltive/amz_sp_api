...
# Unit tests for AmzSpApi::VendorDirectFulfillmentOrders20211228::VendorOrdersApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VendorOrdersApi' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorDirectFulfillmentOrders20211228::VendorOrdersApi.new
  end
  ...
  describe 'test an instance of VendorOrdersApi' do
    it 'should create an instance of VendorOrdersApi' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorDirectFulfillmentOrders20211228::VendorOrdersApi)
    end
  end
