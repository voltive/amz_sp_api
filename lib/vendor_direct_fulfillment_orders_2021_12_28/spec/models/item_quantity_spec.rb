...
# Unit tests for AmzSpApi::VendorDirectFulfillmentOrders20211228::ItemQuantity
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ItemQuantity' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorDirectFulfillmentOrders20211228::ItemQuantity.new
  end
  ...
  describe 'test an instance of ItemQuantity' do
    it 'should create an instance of ItemQuantity' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorDirectFulfillmentOrders20211228::ItemQuantity)
    end
  end
