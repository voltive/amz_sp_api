...
# Unit tests for AmzSpApi::VendorDirectFulfillmentOrders20211228::OrderItemAcknowledgement
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrderItemAcknowledgement' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorDirectFulfillmentOrders20211228::OrderItemAcknowledgement.new
  end
  ...
  describe 'test an instance of OrderItemAcknowledgement' do
    it 'should create an instance of OrderItemAcknowledgement' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorDirectFulfillmentOrders20211228::OrderItemAcknowledgement)
    end
  end
