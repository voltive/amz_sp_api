...
# Unit tests for AmzSpApi::VendorDirectFulfillmentOrders20211228::OrderAcknowledgementItem
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrderAcknowledgementItem' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorDirectFulfillmentOrders20211228::OrderAcknowledgementItem.new
  end
  ...
  describe 'test an instance of OrderAcknowledgementItem' do
    it 'should create an instance of OrderAcknowledgementItem' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorDirectFulfillmentOrders20211228::OrderAcknowledgementItem)
    end
  end
