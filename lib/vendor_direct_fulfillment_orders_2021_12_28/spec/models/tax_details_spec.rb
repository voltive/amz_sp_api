...
# Unit tests for AmzSpApi::VendorDirectFulfillmentOrders20211228::TaxDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TaxDetails' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorDirectFulfillmentOrders20211228::TaxDetails.new
  end
  ...
  describe 'test an instance of TaxDetails' do
    it 'should create an instance of TaxDetails' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorDirectFulfillmentOrders20211228::TaxDetails)
    end
  end
