...
# Unit tests for AmzSpApi::VendorDirectFulfillmentOrders20211228::OrderItem
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrderItem' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorDirectFulfillmentOrders20211228::OrderItem.new
  end
  ...
  describe 'test an instance of OrderItem' do
    it 'should create an instance of OrderItem' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorDirectFulfillmentOrders20211228::OrderItem)
    end
  end
