...
# Unit tests for AmzSpApi::FulfillmentInbound20240320::LtlTrackingDetail
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LtlTrackingDetail' do
  before do
    # run before each test
    @instance = AmzSpApi::FulfillmentInbound20240320::LtlTrackingDetail.new
  end
  ...
  describe 'test an instance of LtlTrackingDetail' do
    it 'should create an instance of LtlTrackingDetail' do
      expect(@instance).to be_instance_of(AmzSpApi::FulfillmentInbound20240320::LtlTrackingDetail)
    end
  end
