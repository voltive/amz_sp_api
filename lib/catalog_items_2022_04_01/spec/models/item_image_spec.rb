...
# Unit tests for AmzSpApi::CatalogItems20220401::ItemImage
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ItemImage' do
  before do
    # run before each test
    @instance = AmzSpApi::CatalogItems20220401::ItemImage.new
  end
  ...
  describe 'test an instance of ItemImage' do
    it 'should create an instance of ItemImage' do
      expect(@instance).to be_instance_of(AmzSpApi::CatalogItems20220401::ItemImage)
    end
  end
