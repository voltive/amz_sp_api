...
# Unit tests for AmzSpApi::CatalogItems20220401::ItemVendorDetailsByMarketplace
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ItemVendorDetailsByMarketplace' do
  before do
    # run before each test
    @instance = AmzSpApi::CatalogItems20220401::ItemVendorDetailsByMarketplace.new
  end
  ...
  describe 'test an instance of ItemVendorDetailsByMarketplace' do
    it 'should create an instance of ItemVendorDetailsByMarketplace' do
      expect(@instance).to be_instance_of(AmzSpApi::CatalogItems20220401::ItemVendorDetailsByMarketplace)
    end
  end
