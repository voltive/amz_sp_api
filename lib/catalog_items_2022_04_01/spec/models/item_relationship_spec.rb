...
# Unit tests for AmzSpApi::CatalogItems20220401::ItemRelationship
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ItemRelationship' do
  before do
    # run before each test
    @instance = AmzSpApi::CatalogItems20220401::ItemRelationship.new
  end
  ...
  describe 'test an instance of ItemRelationship' do
    it 'should create an instance of ItemRelationship' do
      expect(@instance).to be_instance_of(AmzSpApi::CatalogItems20220401::ItemRelationship)
    end
  end
