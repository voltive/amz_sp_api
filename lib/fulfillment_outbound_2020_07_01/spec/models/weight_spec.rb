...
# Unit tests for AmzSpApi::FulfillmentOutbound20200701::Weight
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Weight' do
  before do
    # run before each test
    @instance = AmzSpApi::FulfillmentOutbound20200701::Weight.new
  end
  ...
  describe 'test an instance of Weight' do
    it 'should create an instance of Weight' do
      expect(@instance).to be_instance_of(AmzSpApi::FulfillmentOutbound20200701::Weight)
    end
  end
