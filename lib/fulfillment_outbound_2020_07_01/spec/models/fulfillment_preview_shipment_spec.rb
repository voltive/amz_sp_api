...
# Unit tests for AmzSpApi::FulfillmentOutbound20200701::FulfillmentPreviewShipment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FulfillmentPreviewShipment' do
  before do
    # run before each test
    @instance = AmzSpApi::FulfillmentOutbound20200701::FulfillmentPreviewShipment.new
  end
  ...
  describe 'test an instance of FulfillmentPreviewShipment' do
    it 'should create an instance of FulfillmentPreviewShipment' do
      expect(@instance).to be_instance_of(AmzSpApi::FulfillmentOutbound20200701::FulfillmentPreviewShipment)
    end
  end
