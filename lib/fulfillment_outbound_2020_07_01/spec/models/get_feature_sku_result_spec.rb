...
# Unit tests for AmzSpApi::FulfillmentOutbound20200701::GetFeatureSkuResult
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetFeatureSkuResult' do
  before do
    # run before each test
    @instance = AmzSpApi::FulfillmentOutbound20200701::GetFeatureSkuResult.new
  end
  ...
  describe 'test an instance of GetFeatureSkuResult' do
    it 'should create an instance of GetFeatureSkuResult' do
      expect(@instance).to be_instance_of(AmzSpApi::FulfillmentOutbound20200701::GetFeatureSkuResult)
    end
  end
