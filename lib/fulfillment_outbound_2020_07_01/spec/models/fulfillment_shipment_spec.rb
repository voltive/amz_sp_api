...
# Unit tests for AmzSpApi::FulfillmentOutbound20200701::FulfillmentShipment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FulfillmentShipment' do
  before do
    # run before each test
    @instance = AmzSpApi::FulfillmentOutbound20200701::FulfillmentShipment.new
  end
  ...
  describe 'test an instance of FulfillmentShipment' do
    it 'should create an instance of FulfillmentShipment' do
      expect(@instance).to be_instance_of(AmzSpApi::FulfillmentOutbound20200701::FulfillmentShipment)
    end
  end
