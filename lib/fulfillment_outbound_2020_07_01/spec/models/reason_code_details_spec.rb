...
# Unit tests for AmzSpApi::FulfillmentOutbound20200701::ReasonCodeDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ReasonCodeDetails' do
  before do
    # run before each test
    @instance = AmzSpApi::FulfillmentOutbound20200701::ReasonCodeDetails.new
  end
  ...
  describe 'test an instance of ReasonCodeDetails' do
    it 'should create an instance of ReasonCodeDetails' do
      expect(@instance).to be_instance_of(AmzSpApi::FulfillmentOutbound20200701::ReasonCodeDetails)
    end
  end
