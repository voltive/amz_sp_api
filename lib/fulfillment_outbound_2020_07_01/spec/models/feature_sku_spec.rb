...
# Unit tests for AmzSpApi::FulfillmentOutbound20200701::FeatureSku
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FeatureSku' do
  before do
    # run before each test
    @instance = AmzSpApi::FulfillmentOutbound20200701::FeatureSku.new
  end
  ...
  describe 'test an instance of FeatureSku' do
    it 'should create an instance of FeatureSku' do
      expect(@instance).to be_instance_of(AmzSpApi::FulfillmentOutbound20200701::FeatureSku)
    end
  end
