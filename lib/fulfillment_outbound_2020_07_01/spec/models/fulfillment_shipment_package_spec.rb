...
# Unit tests for AmzSpApi::FulfillmentOutbound20200701::FulfillmentShipmentPackage
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FulfillmentShipmentPackage' do
  before do
    # run before each test
    @instance = AmzSpApi::FulfillmentOutbound20200701::FulfillmentShipmentPackage.new
  end
  ...
  describe 'test an instance of FulfillmentShipmentPackage' do
    it 'should create an instance of FulfillmentShipmentPackage' do
      expect(@instance).to be_instance_of(AmzSpApi::FulfillmentOutbound20200701::FulfillmentShipmentPackage)
    end
  end
