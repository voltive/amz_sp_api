...
# Unit tests for AmzSpApi::FulfillmentOutbound20200701::FulfillmentPreviewItem
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FulfillmentPreviewItem' do
  before do
    # run before each test
    @instance = AmzSpApi::FulfillmentOutbound20200701::FulfillmentPreviewItem.new
  end
  ...
  describe 'test an instance of FulfillmentPreviewItem' do
    it 'should create an instance of FulfillmentPreviewItem' do
      expect(@instance).to be_instance_of(AmzSpApi::FulfillmentOutbound20200701::FulfillmentPreviewItem)
    end
  end
