...
# Unit tests for AmzSpApi::FulfillmentOutbound20200701::FbaOutboundApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FbaOutboundApi' do
  before do
    # run before each test
    @instance = AmzSpApi::FulfillmentOutbound20200701::FbaOutboundApi.new
  end
  ...
  describe 'test an instance of FbaOutboundApi' do
    it 'should create an instance of FbaOutboundApi' do
      expect(@instance).to be_instance_of(AmzSpApi::FulfillmentOutbound20200701::FbaOutboundApi)
    end
  end
