...
# Unit tests for AmzSpApi::AplusContent20201101::ContentRecord
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ContentRecord' do
  before do
    # run before each test
    @instance = AmzSpApi::AplusContent20201101::ContentRecord.new
  end
  ...
  describe 'test an instance of ContentRecord' do
    it 'should create an instance of ContentRecord' do
      expect(@instance).to be_instance_of(AmzSpApi::AplusContent20201101::ContentRecord)
    end
  end
