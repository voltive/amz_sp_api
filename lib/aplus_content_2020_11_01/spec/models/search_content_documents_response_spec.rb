...
# Unit tests for AmzSpApi::AplusContent20201101::SearchContentDocumentsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SearchContentDocumentsResponse' do
  before do
    # run before each test
    @instance = AmzSpApi::AplusContent20201101::SearchContentDocumentsResponse.new
  end
  ...
  describe 'test an instance of SearchContentDocumentsResponse' do
    it 'should create an instance of SearchContentDocumentsResponse' do
      expect(@instance).to be_instance_of(AmzSpApi::AplusContent20201101::SearchContentDocumentsResponse)
    end
  end
