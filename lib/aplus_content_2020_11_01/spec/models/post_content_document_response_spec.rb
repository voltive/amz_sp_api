...
# Unit tests for AmzSpApi::AplusContent20201101::PostContentDocumentResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PostContentDocumentResponse' do
  before do
    # run before each test
    @instance = AmzSpApi::AplusContent20201101::PostContentDocumentResponse.new
  end
  ...
  describe 'test an instance of PostContentDocumentResponse' do
    it 'should create an instance of PostContentDocumentResponse' do
      expect(@instance).to be_instance_of(AmzSpApi::AplusContent20201101::PostContentDocumentResponse)
    end
  end
