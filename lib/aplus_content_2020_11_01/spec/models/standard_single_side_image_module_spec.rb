...
# Unit tests for AmzSpApi::AplusContent20201101::StandardSingleSideImageModule
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'StandardSingleSideImageModule' do
  before do
    # run before each test
    @instance = AmzSpApi::AplusContent20201101::StandardSingleSideImageModule.new
  end
  ...
  describe 'test an instance of StandardSingleSideImageModule' do
    it 'should create an instance of StandardSingleSideImageModule' do
      expect(@instance).to be_instance_of(AmzSpApi::AplusContent20201101::StandardSingleSideImageModule)
    end
  end
