...
# Unit tests for AmzSpApi::ListingsItems20210801::IssueExemption
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IssueExemption' do
  before do
    # run before each test
    @instance = AmzSpApi::ListingsItems20210801::IssueExemption.new
  end
  ...
  describe 'test an instance of IssueExemption' do
    it 'should create an instance of IssueExemption' do
      expect(@instance).to be_instance_of(AmzSpApi::ListingsItems20210801::IssueExemption)
    end
  end
