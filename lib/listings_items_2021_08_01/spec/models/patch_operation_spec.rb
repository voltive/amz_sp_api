...
# Unit tests for AmzSpApi::ListingsItems20210801::PatchOperation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PatchOperation' do
  before do
    # run before each test
    @instance = AmzSpApi::ListingsItems20210801::PatchOperation.new
  end
  ...
  describe 'test an instance of PatchOperation' do
    it 'should create an instance of PatchOperation' do
      expect(@instance).to be_instance_of(AmzSpApi::ListingsItems20210801::PatchOperation)
    end
  end
