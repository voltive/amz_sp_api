...
# Unit tests for AmzSpApi::ListingsItems20210801::ItemSummaryByMarketplace
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ItemSummaryByMarketplace' do
  before do
    # run before each test
    @instance = AmzSpApi::ListingsItems20210801::ItemSummaryByMarketplace.new
  end
  ...
  describe 'test an instance of ItemSummaryByMarketplace' do
    it 'should create an instance of ItemSummaryByMarketplace' do
      expect(@instance).to be_instance_of(AmzSpApi::ListingsItems20210801::ItemSummaryByMarketplace)
    end
  end
