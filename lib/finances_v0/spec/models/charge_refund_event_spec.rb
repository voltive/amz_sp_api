...
# Unit tests for AmzSpApi::FinancesV0::ChargeRefundEvent
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChargeRefundEvent' do
  before do
    # run before each test
    @instance = AmzSpApi::FinancesV0::ChargeRefundEvent.new
  end
  ...
  describe 'test an instance of ChargeRefundEvent' do
    it 'should create an instance of ChargeRefundEvent' do
      expect(@instance).to be_instance_of(AmzSpApi::FinancesV0::ChargeRefundEvent)
    end
  end
