...
# Unit tests for AmzSpApi::ShippingV2::ShippingApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ShippingApi' do
  before do
    # run before each test
    @instance = AmzSpApi::ShippingV2::ShippingApi.new
  end
  ...
  describe 'test an instance of ShippingApi' do
    it 'should create an instance of ShippingApi' do
      expect(@instance).to be_instance_of(AmzSpApi::ShippingV2::ShippingApi)
    end
  end
