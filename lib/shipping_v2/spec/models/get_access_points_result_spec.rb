...
# Unit tests for AmzSpApi::ShippingV2::GetAccessPointsResult
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetAccessPointsResult' do
  before do
    # run before each test
    @instance = AmzSpApi::ShippingV2::GetAccessPointsResult.new
  end
  ...
  describe 'test an instance of GetAccessPointsResult' do
    it 'should create an instance of GetAccessPointsResult' do
      expect(@instance).to be_instance_of(AmzSpApi::ShippingV2::GetAccessPointsResult)
    end
  end
