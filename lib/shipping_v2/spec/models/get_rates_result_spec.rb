...
# Unit tests for AmzSpApi::ShippingV2::GetRatesResult
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetRatesResult' do
  before do
    # run before each test
    @instance = AmzSpApi::ShippingV2::GetRatesResult.new
  end
  ...
  describe 'test an instance of GetRatesResult' do
    it 'should create an instance of GetRatesResult' do
      expect(@instance).to be_instance_of(AmzSpApi::ShippingV2::GetRatesResult)
    end
  end
