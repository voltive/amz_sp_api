...
# Unit tests for AmzSpApi::ShippingV2::ValidationMetadata
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ValidationMetadata' do
  before do
    # run before each test
    @instance = AmzSpApi::ShippingV2::ValidationMetadata.new
  end
  ...
  describe 'test an instance of ValidationMetadata' do
    it 'should create an instance of ValidationMetadata' do
      expect(@instance).to be_instance_of(AmzSpApi::ShippingV2::ValidationMetadata)
    end
  end
