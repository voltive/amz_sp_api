...
# Unit tests for AmzSpApi::ShippingV2::ChargeComponent
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChargeComponent' do
  before do
    # run before each test
    @instance = AmzSpApi::ShippingV2::ChargeComponent.new
  end
  ...
  describe 'test an instance of ChargeComponent' do
    it 'should create an instance of ChargeComponent' do
      expect(@instance).to be_instance_of(AmzSpApi::ShippingV2::ChargeComponent)
    end
  end
