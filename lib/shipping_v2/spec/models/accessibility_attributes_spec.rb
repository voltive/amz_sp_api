...
# Unit tests for AmzSpApi::ShippingV2::AccessibilityAttributes
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AccessibilityAttributes' do
  before do
    # run before each test
    @instance = AmzSpApi::ShippingV2::AccessibilityAttributes.new
  end
  ...
  describe 'test an instance of AccessibilityAttributes' do
    it 'should create an instance of AccessibilityAttributes' do
      expect(@instance).to be_instance_of(AmzSpApi::ShippingV2::AccessibilityAttributes)
    end
  end
