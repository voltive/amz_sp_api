...
# Unit tests for AmzSpApi::ShippingV2::GetCollectionFormResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCollectionFormResponse' do
  before do
    # run before each test
    @instance = AmzSpApi::ShippingV2::GetCollectionFormResponse.new
  end
  ...
  describe 'test an instance of GetCollectionFormResponse' do
    it 'should create an instance of GetCollectionFormResponse' do
      expect(@instance).to be_instance_of(AmzSpApi::ShippingV2::GetCollectionFormResponse)
    end
  end
