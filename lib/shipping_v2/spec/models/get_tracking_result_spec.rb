...
# Unit tests for AmzSpApi::ShippingV2::GetTrackingResult
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetTrackingResult' do
  before do
    # run before each test
    @instance = AmzSpApi::ShippingV2::GetTrackingResult.new
  end
  ...
  describe 'test an instance of GetTrackingResult' do
    it 'should create an instance of GetTrackingResult' do
      expect(@instance).to be_instance_of(AmzSpApi::ShippingV2::GetTrackingResult)
    end
  end
