...
# Unit tests for AmzSpApi::ShippingV2::GetShipmentDocumentsResult
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetShipmentDocumentsResult' do
  before do
    # run before each test
    @instance = AmzSpApi::ShippingV2::GetShipmentDocumentsResult.new
  end
  ...
  describe 'test an instance of GetShipmentDocumentsResult' do
    it 'should create an instance of GetShipmentDocumentsResult' do
      expect(@instance).to be_instance_of(AmzSpApi::ShippingV2::GetShipmentDocumentsResult)
    end
  end
