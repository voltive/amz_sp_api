...
# Unit tests for AmzSpApi::ShippingV2::SupportedDocumentSpecification
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SupportedDocumentSpecification' do
  before do
    # run before each test
    @instance = AmzSpApi::ShippingV2::SupportedDocumentSpecification.new
  end
  ...
  describe 'test an instance of SupportedDocumentSpecification' do
    it 'should create an instance of SupportedDocumentSpecification' do
      expect(@instance).to be_instance_of(AmzSpApi::ShippingV2::SupportedDocumentSpecification)
    end
  end
