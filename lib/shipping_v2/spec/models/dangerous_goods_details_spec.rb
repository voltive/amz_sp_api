...
# Unit tests for AmzSpApi::ShippingV2::DangerousGoodsDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DangerousGoodsDetails' do
  before do
    # run before each test
    @instance = AmzSpApi::ShippingV2::DangerousGoodsDetails.new
  end
  ...
  describe 'test an instance of DangerousGoodsDetails' do
    it 'should create an instance of DangerousGoodsDetails' do
      expect(@instance).to be_instance_of(AmzSpApi::ShippingV2::DangerousGoodsDetails)
    end
  end
