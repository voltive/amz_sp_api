...
# Unit tests for AmzSpApi::ShippingV2::DirectFulfillmentItemIdentifiers
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DirectFulfillmentItemIdentifiers' do
  before do
    # run before each test
    @instance = AmzSpApi::ShippingV2::DirectFulfillmentItemIdentifiers.new
  end
  ...
  describe 'test an instance of DirectFulfillmentItemIdentifiers' do
    it 'should create an instance of DirectFulfillmentItemIdentifiers' do
      expect(@instance).to be_instance_of(AmzSpApi::ShippingV2::DirectFulfillmentItemIdentifiers)
    end
  end
