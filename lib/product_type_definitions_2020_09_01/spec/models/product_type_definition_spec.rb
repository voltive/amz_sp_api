...
# Unit tests for AmzSpApi::ProductTypeDefinitions20200901::ProductTypeDefinition
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProductTypeDefinition' do
  before do
    # run before each test
    @instance = AmzSpApi::ProductTypeDefinitions20200901::ProductTypeDefinition.new
  end
  ...
  describe 'test an instance of ProductTypeDefinition' do
    it 'should create an instance of ProductTypeDefinition' do
      expect(@instance).to be_instance_of(AmzSpApi::ProductTypeDefinitions20200901::ProductTypeDefinition)
    end
  end
