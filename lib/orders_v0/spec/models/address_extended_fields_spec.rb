...
# Unit tests for AmzSpApi::OrdersV0::AddressExtendedFields
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AddressExtendedFields' do
  before do
    # run before each test
    @instance = AmzSpApi::OrdersV0::AddressExtendedFields.new
  end
  ...
  describe 'test an instance of AddressExtendedFields' do
    it 'should create an instance of AddressExtendedFields' do
      expect(@instance).to be_instance_of(AmzSpApi::OrdersV0::AddressExtendedFields)
    end
  end
