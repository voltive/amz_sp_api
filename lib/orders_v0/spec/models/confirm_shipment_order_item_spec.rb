...
# Unit tests for AmzSpApi::OrdersV0::ConfirmShipmentOrderItem
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ConfirmShipmentOrderItem' do
  before do
    # run before each test
    @instance = AmzSpApi::OrdersV0::ConfirmShipmentOrderItem.new
  end
  ...
  describe 'test an instance of ConfirmShipmentOrderItem' do
    it 'should create an instance of ConfirmShipmentOrderItem' do
      expect(@instance).to be_instance_of(AmzSpApi::OrdersV0::ConfirmShipmentOrderItem)
    end
  end
