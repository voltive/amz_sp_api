...
# Unit tests for AmzSpApi::OrdersV0::OpenInterval
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OpenInterval' do
  before do
    # run before each test
    @instance = AmzSpApi::OrdersV0::OpenInterval.new
  end
  ...
  describe 'test an instance of OpenInterval' do
    it 'should create an instance of OpenInterval' do
      expect(@instance).to be_instance_of(AmzSpApi::OrdersV0::OpenInterval)
    end
  end
