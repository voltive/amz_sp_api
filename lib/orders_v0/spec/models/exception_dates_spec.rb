...
# Unit tests for AmzSpApi::OrdersV0::ExceptionDates
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ExceptionDates' do
  before do
    # run before each test
    @instance = AmzSpApi::OrdersV0::ExceptionDates.new
  end
  ...
  describe 'test an instance of ExceptionDates' do
    it 'should create an instance of ExceptionDates' do
      expect(@instance).to be_instance_of(AmzSpApi::OrdersV0::ExceptionDates)
    end
  end
