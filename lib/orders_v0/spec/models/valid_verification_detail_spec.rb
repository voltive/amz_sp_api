...
# Unit tests for AmzSpApi::OrdersV0::ValidVerificationDetail
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ValidVerificationDetail' do
  before do
    # run before each test
    @instance = AmzSpApi::OrdersV0::ValidVerificationDetail.new
  end
  ...
  describe 'test an instance of ValidVerificationDetail' do
    it 'should create an instance of ValidVerificationDetail' do
      expect(@instance).to be_instance_of(AmzSpApi::OrdersV0::ValidVerificationDetail)
    end
  end
