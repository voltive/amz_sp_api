...
# Unit tests for AmzSpApi::Finances20240619::ListTransactionsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListTransactionsResponse' do
  before do
    # run before each test
    @instance = AmzSpApi::Finances20240619::ListTransactionsResponse.new
  end
  ...
  describe 'test an instance of ListTransactionsResponse' do
    it 'should create an instance of ListTransactionsResponse' do
      expect(@instance).to be_instance_of(AmzSpApi::Finances20240619::ListTransactionsResponse)
    end
  end
