...
# Unit tests for AmzSpApi::Finances20240619::ItemRelatedIdentifier
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ItemRelatedIdentifier' do
  before do
    # run before each test
    @instance = AmzSpApi::Finances20240619::ItemRelatedIdentifier.new
  end
  ...
  describe 'test an instance of ItemRelatedIdentifier' do
    it 'should create an instance of ItemRelatedIdentifier' do
      expect(@instance).to be_instance_of(AmzSpApi::Finances20240619::ItemRelatedIdentifier)
    end
  end
