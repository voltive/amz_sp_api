...
# Unit tests for AmzSpApi::DataKiosk20231115::CreateQuerySpecification
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateQuerySpecification' do
  before do
    # run before each test
    @instance = AmzSpApi::DataKiosk20231115::CreateQuerySpecification.new
  end
  ...
  describe 'test an instance of CreateQuerySpecification' do
    it 'should create an instance of CreateQuerySpecification' do
      expect(@instance).to be_instance_of(AmzSpApi::DataKiosk20231115::CreateQuerySpecification)
    end
  end
