...
# Unit tests for AmzSpApi::DataKiosk20231115::QueriesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'QueriesApi' do
  before do
    # run before each test
    @instance = AmzSpApi::DataKiosk20231115::QueriesApi.new
  end
  ...
  describe 'test an instance of QueriesApi' do
    it 'should create an instance of QueriesApi' do
      expect(@instance).to be_instance_of(AmzSpApi::DataKiosk20231115::QueriesApi)
    end
  end
