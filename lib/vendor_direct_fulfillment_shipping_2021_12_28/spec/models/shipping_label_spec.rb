...
# Unit tests for AmzSpApi::VendorDirectFulfillmentShipping20211228::ShippingLabel
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ShippingLabel' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorDirectFulfillmentShipping20211228::ShippingLabel.new
  end
  ...
  describe 'test an instance of ShippingLabel' do
    it 'should create an instance of ShippingLabel' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorDirectFulfillmentShipping20211228::ShippingLabel)
    end
  end
