...
# Unit tests for AmzSpApi::VendorDirectFulfillmentShipping20211228::ShipmentConfirmation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ShipmentConfirmation' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorDirectFulfillmentShipping20211228::ShipmentConfirmation.new
  end
  ...
  describe 'test an instance of ShipmentConfirmation' do
    it 'should create an instance of ShipmentConfirmation' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorDirectFulfillmentShipping20211228::ShipmentConfirmation)
    end
  end
