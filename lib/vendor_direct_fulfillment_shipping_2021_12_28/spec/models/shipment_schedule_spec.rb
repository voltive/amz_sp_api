...
# Unit tests for AmzSpApi::VendorDirectFulfillmentShipping20211228::ShipmentSchedule
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ShipmentSchedule' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorDirectFulfillmentShipping20211228::ShipmentSchedule.new
  end
  ...
  describe 'test an instance of ShipmentSchedule' do
    it 'should create an instance of ShipmentSchedule' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorDirectFulfillmentShipping20211228::ShipmentSchedule)
    end
  end
