...
# Unit tests for AmzSpApi::VendorDirectFulfillmentShipping20211228::TaxRegistrationDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TaxRegistrationDetails' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorDirectFulfillmentShipping20211228::TaxRegistrationDetails.new
  end
  ...
  describe 'test an instance of TaxRegistrationDetails' do
    it 'should create an instance of TaxRegistrationDetails' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorDirectFulfillmentShipping20211228::TaxRegistrationDetails)
    end
  end
