...
# Unit tests for AmzSpApi::VendorDirectFulfillmentShipping20211228::PackedItem
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PackedItem' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorDirectFulfillmentShipping20211228::PackedItem.new
  end
  ...
  describe 'test an instance of PackedItem' do
    it 'should create an instance of PackedItem' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorDirectFulfillmentShipping20211228::PackedItem)
    end
  end
